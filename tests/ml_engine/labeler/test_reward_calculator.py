...
def test_calculate_reward_skip_returns_zero(rc):
    ...
    assert rc.calculate_reward(action=2, is_correct=True, gate_passed=True) == 0.0
...
def test_calculate_reward_skip_ignores_is_correct_and_gate(rc):
    ...
    assert rc.calculate_reward(action=2, is_correct=False, gate_passed=False) == 0.0
    assert rc.calculate_reward(action=2, is_correct=True, gate_passed=False) == 0.0
    assert rc.calculate_reward(action=2, is_correct=False, gate_passed=True) == 0.0
