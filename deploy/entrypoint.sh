#!/bin/bash
# set -e intentionally omitted — individual download failures must not abort
# startup. Each download logs success/failure and the script always reaches
# exec python.
set -uo pipefail
